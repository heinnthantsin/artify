  ...
  return (
    <footer style={{
      ...
      <div style={{
        ...
        <div style={{ flex: '1 1 20%', marginBottom: '20px', marginLeft: '30px', lineHeight: '1.5' }}>
          <div className="footer-menus">
            <h3 style={{ marginBottom: '10px', fontWeight: 'bold', textTransform: 'uppercase' }}>Quick Links</h3>
            <ul style={{ listStyleType: 'none', padding: '0' }}>
              <li style={{ marginBottom: '10px' }}><HoverLink href="#">Home</HoverLink></li>
              <li style={{ marginBottom: '10px' }}><HoverLink href="#">Artists</HoverLink></li>
              <li style={{ marginBottom: '10px' }}><HoverLink href="#">Events</HoverLink></li>
              <li style={{ marginBottom: '10px' }}><HoverLink href="#">Products</HoverLink></li>
              <li><HoverLink href="#">Contact Us</HoverLink></li>
            </ul>
          </div>
        </div>
        {/* sub form */}
        <div style={{ flex: '1 1 25%', marginBottom: '20px', marginRight: '50px' }}>

          <p style={{ display: 'flex', gap: '10px', fontWeight: 'bold', textTransform: 'uppercase', marginBottom: '10px' }}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#204045" fill="none">
