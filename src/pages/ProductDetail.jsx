...
function ProductDetail() {
  ...
  return (
    <>
      ...
      <FollowingList itemList={productData} sectionTitle={"Recommended Products"} />
      <Link to="/product">
        <Button customeClass="w-auto" buttonName={<svg xmlns=" http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#000000"} fill={"none"}>
